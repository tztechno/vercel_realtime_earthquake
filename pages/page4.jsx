...
const Page4 = () => {
    ...
    useEffect(() => {
        ...
        const shiftInterval = setInterval(() => {
            setCurrentIndex((prevIndex) => {
                ...
                const maxStartIndex = Math.max(total - 8, 0); // Calculate max start index to stay within bounds
    ...
    // Get the slice of data to display (5 rows, starting from currentIndex)
    const displayedData = sortedData.slice(currentIndex, currentIndex + 8);
